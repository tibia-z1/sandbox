...
-- Pattern:
-- Columns: 1018, 1042, 1066, 1091
-- Vertical step: 24
-- First Y: 1112
-- Last confirmed Y: 1736
-- Monks spawn at x-1,y-1,z and x+1,y-1,z

local trainingRooms = {}

local trainingColumns = {1018, 1042, 1066, 1091}
local startY = 1112
local roomsPerColumn = 27
local yStep = 24
local z = 7
...
respawnEvent:interval(10000) -- 10 seconds
