...
function dailyChest.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    local rewards = {
        { text = "100 crystal coins", id = 3043, count = 100 },
        { text = "100 Zero1 Coins", id = 22118, count = 100 },

        { text = "training item 28540", id = 28540, count = 1 },
        { text = "training item 28543", id = 28543, count = 1 },
        { text = "training item 28545", id = 28545, count = 1 },
        { text = "training item 44064", id = 44064, count = 1 },

        { text = "rare item 39040", id = 39040, count = 1 },
        { text = "rare item 39038", id = 39038, count = 1 },
    }
